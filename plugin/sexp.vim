...
let s:sexp_mappings = {
    ...
    \ 'sexp_flow_to_prev_close':        '<f',
    \ 'sexp_flow_to_next_open':         '>f',
    ...
    \ 'sexp_select_prev_element':       '<s',
    \ 'sexp_select_next_element':       '>s',
    \ 'sexp_indent':                    '==',
    \ 'sexp_indent_top':                '=-',
    \ 'sexp_round_head_wrap_list':      '<LocalLeader>wl',
    \ 'sexp_round_tail_wrap_list':      '<LocalLeader>Wl',
    \ 'sexp_square_head_wrap_list':     '<LocalLeader>wv',
    \ 'sexp_square_tail_wrap_list':     '<LocalLeader>Wv',
    \ 'sexp_curly_head_wrap_list':      '<LocalLeader>wm',
    \ 'sexp_curly_tail_wrap_list':      '<LocalLeader>Wm',
    \ 'sexp_round_head_wrap_element':   '<LocalLeader>wel',
    \ 'sexp_round_tail_wrap_element':   '<LocalLeader>Wel',
    \ 'sexp_square_head_wrap_element':  '<LocalLeader>wev',
    \ 'sexp_square_tail_wrap_element':  '<LocalLeader>Wev',
    \ 'sexp_curly_head_wrap_element':   '<LocalLeader>wem',
    \ 'sexp_curly_tail_wrap_element':   '<LocalLeader>Wem',
    \ 'sexp_insert_at_list_head':       '<I',
    \ 'sexp_insert_at_list_tail':       '>I',
    \ 'sexp_splice_list':               '<LocalLeader>@',
    \ 'sexp_convolute':                 '<LocalLeader>?',
    \ 'sexp_raise_list':                '<LocalLeader>ul',
    \ 'sexp_raise_element':             '<LocalLeader>ue',
    \ 'sexp_swap_list_backward':        '<l',
